import { toUni } from "../_functions/Functions0";

const AtHigherLevels = "\n   " + toUni("At Higher Levels") + ": ";

const Base_spellLevelList = [
  "Cantrips (0-level)",
  "1st-level",
  "2nd-level",
  "3rd-level",
...
const Base_SpellsList = {
  ...
  "blade barrier": {
    ...
    save: "Dex",
    description:
      "100\xD720\xD75ft (l\xD7w\xD7h) wall or 30 rad 20\xD75ft (w\xD7h) ring; 6d10 Slashing dmg; save halves; 3/4 cover",
    descriptionMetric:
      "60\xD76\xD71,5m (l\xD7w\xD7h) wall or 9 rad 6\xD71,5m (w\xD7h) ring; 6d10 Slashing dmg; save halves; 3/4 cover",
    descriptionShorter: typePF
      ? false
      : "100|20|5ft (l|w|h) wall or 30|20|5ft (r|w|h) ring; 6d10 Slashing dmg; save half; \u00BEcover",
    descriptionShorterMetric: typePF
      ? false
      : "60|6|1,5m (l|w|h) wall or 9|6|1,5m (r|w|h) ring; 6d10 Slash. dmg; save half; \u00BEcover",
    descriptionFull:
  ...
  "call lightning": {
    ...
    descriptionShorter:
      "60-ft rad 10-ft high cloud; 1 a all in 5-ft rad under it 3d10+1d10/SL Lightn. dmg; save half",
    descriptionFull:
  ...
  "chill touch": {
    ...
    descriptionShorter:
      "Spell attack for 1d8 Necrotic dmg; can't regain HP; undead dis. atks vs. me; +1d8 at CL 5/11/17",
    descriptionCantripDie:
  ...
  cloudkill: {
    ...
    descriptionShorter:
      "20-ft rad 5d8+1d8/SL Poison dmg; save halves; move 10 ft/rnd; heavily obscured, dif. ter.",
    descriptionFull:
  ...
  "control weather": {
    ...
    duration: "Conc, 8 h",
    description:
      "Change current weather; changes take 1d4\xD710 min; change precipitation, temperature, wind, see B",
    descriptionFull:
  ...
  counterspell: {
    ...
    duration: "Instantaneous",
    description:
      "Stop a spell being cast; if above SL of this spell, make DC 10+SL spellcasting ability check",
    descriptionFull:
  ...
  "create or destroy water": {
    ...
    duration: "Instantaneous",
    description:
      "Create/destroy 10+10/SL gal of water in open container or create rain/destroy fog in 30+5/SL-ft cu",
    descriptionFull:
  ...
  disintegrate: {
    ...
    save: "Dex",
    description:
      "1 crea save or 40+10d6+3d6/SL Force dmg; or up to 10-ft cube nonmagical object is destroyed",
    descriptionFull:
  ...
  "dispel magic": {
    ...
    duration: "Instantaneous",
    description:
      "Dispel all magical effects on crea or object; if above this SL, DC 10+SL spellcasting ability check",
    descriptionFull:
  ...
  "eldritch blast": {
    ...
    descriptionShorter:
      "Spell atk beam 1d10 Force damage; can combine/split beams; CL5:2, CL11:3, CL17:4 beams",
    descriptionCantripDie:
  ...
  "econstd's black tentacles": {
    name: "Econstd's Black Tentacles",
    ...
    save: "Dex",
    description:
      "All who enter/start 20-ft square save or restrained \u0026 3d6 Bludg. dmg/rnd; Str/Dex check to escape",
    descriptionShorter:
      "All enter/start 20-ft square save or restrained \u0026 3d6 Bludg. dmg/rnd; Str/Dex chk escape",
    descriptionFull:
  ...
  "fire shield": {
    ...
    descriptionShorter:
      "Fiery shield; Fire or Cold dmg resistance; deals 2d8 of other dmg type to melee attackers",
    descriptionFull:
  ...
  "flame blade": {
    ...
    descriptionShorter:
      "Summon fiery blade; 1 a to make melee spell atk 3d6+1d6/2SL Fire dmg; 10 ft bright light",
    descriptionFull:
  ...
  "flame strike": {
    ...
    save: "Dex",
    description:
      "10-ft rad 40-ft high all crea 4d6 Fire dmg and 4d6 Radiant dmg; save halves; +1d6/SL Fire or Radiant",
    descriptionShorter:
      "10-ft rad 40-ft high all crea 4d6 Fire dmg and 4d6 Radiant dmg; save half; +1d6/SL dmg",
    descriptionFull:
  ...
  "flaming sphere": {
    ...
    descriptionShorter:
      "2.5-ft rad flaming sphere; bns a move 30 ft; all in 5-ft rad 2d6+1d6/SL Fire dmg; save half",
    descriptionFull:
  ...
  forbiddance: {
    ...
    duration: "1 day",
    description:
      "40k sq ft 30-ft high no extraplanar travel; 1 crea type 5d10 Radiant/Necrotic dmg per rnd (1000gp)",
    descriptionMetric:
      "3,7k m2 9-m high no extraplanar travel; 1 crea type 5d10 Radiant or Necrotic dmg per rnd (1000gp)",
    descriptionShorter:
      "40k sq ft 30ft high no planar travel; 1 crea type 5d10 Radiant/Necro. dmg/rnd (1k gp)",
    descriptionShorterMetric:
      "3,6k m2 9-m high no planar travel; 1 crea type 5d10 Radiant/Necrotic dmg/rnd (1k gp)",
    descriptionFull:
    ...
    dynamicDamageBonus: {
      multipleDmgTypes: {
        ...
        inDescriptionAs:
          "Radiant/Necrotic|Radiant/Necro\\.|Radiant or Necrotic",
      },
    },
  },
  forcecage: {
  ...
  "freedom of movement": {
    ...
    duration: "1 h",
    description:
      "1 willing crea; magic cannot reduce speed, paralyze, restrain; use 5 ft to escape nonmagical restraints",
    descriptionFull:
  ...
  geas: {
    ...
    descriptionShorter:
      "1 crea save or charmed, it must obey order or 5d10 Psychic dmg; SL7: 1 year, SL9: 'til disp.",
    descriptionFull:
  ...
  goodberry: {
    ...
    duration: "Instantaneous",
    description:
      "Create 10 berries; 1 a to eat 1 berry: heal 1 HP, nourishment for 1 day; berries lose potency after 24h",
    descriptionShorter:
      "Create 10 berries; 1 a to eat 1 berry: heal 1 HP, nourishment for 1 day; lose potency after 24h",
    descriptionFull:
  ...
  "guardian of faith": {
    ...
    descriptionShorter:
      "Place spectre; hostiles enter in 10 ft 20 Radiant dmg; save half; vanishes after doing 60 dmg",
    descriptionFull:
  ...
  heal: {
    ...
    descriptionShorter:
      "1 living creature heals 70+10/SL HP and is cured of blindness, deafness, all diseases",
    descriptionFull:
  ...
  "heat metal": {
    ...
    save: "Con",
    description:
      "1 metal obj on touch 2d8+1d8/SL Fire dmg; save or drop obj; if held: dis. atk/chk; bns a reheat obj",
    descriptionShorter:
      "1 metal obj, touch it 2d8+1d8/SL Fire dmg; save or drop it; if held: dis. atk/chk; bns a redo",
    descriptionFull:
  ...
  "holy aura": {
    ...
    save: "Con",
    description:
      "Any in 30 ft of me adv. saves; dis. atks vs. targets; fiend/undead atk a target save or blinded (1000gp)",
    descriptionFull:
  ...
  imprisonment: {
    ...
    components: "V,S,M\u2020",
    compMaterial:
      "A vellum depiction or a carved statuette in the likeness of the target, and a special component that consties according to the version of the spell you choose, worth at least 500 gp per Hit Die of the target",
    duration: "Till dispelled",
    save: "Wis",
    description:
  ...
  "incendiary cloud": {
    ...
    save: "Dex",
    description:
      "20-ft rad all now/enter/end turn 10d8 Fire dmg; save half; heavily obscures; moves 10 ft/rnd away",
    descriptionShorter:
      "20-ft rad all now/enter/end turn 10d8 Fire dmg; save half; heavy obsc.; moves 10 ft/rnd",
    descriptionFull:
  ...
  "insect plague": {
    ...
    save: "Con",
    description:
      "20-ft rad all now/enter/end turn 4d10+1d10/SL Piercing dmg; save half, no cover; light obsc.; dif. ter",
    descriptionShorter:
      "20-ft rad all now/enter/end 4d10+1d10/SL Piercing dmg; save half; light obscures; dif. ter.",
    descriptionFull:
  ...
  "mass heal": {
    ...
    duration: "Instantaneous",
    description:
      "Heal 700 HP split over any crea in range; each healed is cured of blindness, deafness, and all diseases",
    descriptionShorter:
      "Heal 700 HP split over any crea in range; each healed cured of blindness, deafness, diseases",
    descriptionFull:
  ...
  "melf's acid arrow": {
    ...
    descriptionShorter:
      "Spell atk for 4d4+1d4/SL Acid dmg \u0026 2d4+1d4/SL next turn; miss: half dmg, no next turn",
    descriptionFull:
  ...
  "meteor swarm": {
    ...
    save: "Dex",
    description:
      "4\xD7 40-ft rad all 20d6 Bludgeoning dmg and 20d6 Fire dmg; save halves; areas do not stack",
    descriptionFull:
  ...
  moonbeam: {
    ...
    save: "Con",
    description:
      "5-ft rad 40-ft high all enter/start turn 2d10+1d10/SL Radiant dmg; save half; 1 a move it 60 ft; see B",
    descriptionShorter:
      "5-ft rad 40-ft high all enter/start 2d10+1d10/SL Radiant dmg; save half; 1 a move 60 ft",
    descriptionFull:
  ...
  "mordenkainen's faithful hound": {
    ...
    duration: "8 h (D)",
    description:
      "Invisible, immobile dog does melee spell atk for 4d8 Piercing dmg; sees invisible/ethereal; see book",
    descriptionShorter:
      "Invisible, immobile dog do melee spell atk 4d8 Piercing dmg; sees invisible/ethereal; see B",
    descriptionFull:
  ...
  "mordenkainen's sword": {
    ...
    descriptionShorter:
      "Hovering sword makes melee spell atk 3d10 Force dmg; bns a to move 20 ft and/or attack",
    descriptionFull:
  ...
  "otto's irresistible dance": {
    ...
    duration: "Conc, 1 min",
    description:
      "1 crea dances in place, can't move, dis. on atks/Dex saves, adv. on atks vs. target; 1 a Wis save to end",
    descriptionFull:
  ...
  "planar ally": {
    ...
    descriptionFull:
      ...
      "\n   " +
      "Payment can take a constiety of forms. A celestial might require a sizable donation of gold or magic items to an allied temple, while a fiend might demand a living sacrifice or a gift of treasure. Some creatures might exchange their service for a quest undertaken by you." +
      "\n   " +
  ...
  "prismatic spray": {
    ...
    save: "Dex",
    description:
      "All random effect each, see book: either 10d6 dmg, restrained, or blinded; save halves/negates",
    descriptionFull:
  ...
  regenerate: {
    ...
    descriptionShorter:
      "1 crea heals 4d8+15 HP and 1 HP/rnd for the duration; restores lost body parts in 2 min",
    descriptionFull:
  ...
  resurrection: {
    ...
    duration: "Instantaneous",
    description:
      "Resurrects a crea that died in the last century to life with whole body and full HP; see B (1000gp cons.)",
    descriptionFull:
  ...
  "rope trick": {
    ...
    duration: "1 h",
    description:
      "Rope up to 60 ft stands vertical; extradimens. space with invisible 3\xD75 ft entrance at top, for 8 crea",
    descriptionFull:
  ...
  "sacred flame": {
    ...
    save: "Dex",
    description:
      "1 crea that I can see save or 1d8 Radiant dmg; no bonus for cover on save; +1d8 at CL 5, 11, and 17",
    descriptionShorter:
      "1 crea that I can see save or 1d8 Radiant dmg; no bonus for cover on save; +1d8 at CL 5/11/17",
    descriptionCantripDie:
      "1 creature that I can see save or `CD`d8 Radiant dmg; no bonus for cover on save",
    descriptionFull:
  ...
  shillelagh: {
    ...
    duration: "1 min",
    description:
      "Club/quarterstaff I hold does 1d8 Bludg. dmg and uses my spellcasting ability modifier instead of Str",
    descriptionShorter:
      "Club/quarterstaff I hold does 1d8 Bludg. dmg \u0026 uses my spellcasting modifier instead of Str",
    descriptionFull:
  ...
  "spike growth": {
    ...
    descriptionShorter:
      "20-ft rad dif. ter.; all 2d4 Piercing dmg per 5 ft moved; Wis(Perc) vs. Spell DC to recognize",
    descriptionFull:
  ...
  "spirit guardians": {
    ...
    descriptionShorter:
      "Any crea start turn/enter area half speed, 3d8+1d8/SL Radiant/Necrotic dmg; save half",
    descriptionFull:
  ...
  "spiritual weapon": {
    ...
    descriptionShorter:
      "Create wea; spell atk 1d8+1d8/2SL+spell modifier Force dmg; bns a move 20 ft and/or atk",
    descriptionFull:
  ...
  sunbeam: {
    ...
    descriptionShorter:
      "60-ft long 5-ft wide all 6d8 Radiant dmg, 1 rnd blind; save half, not blind; 1 a for new line",
    descriptionFull:
  ...
  "true resurrection": {
    ...
    duration: "Instantaneous",
    description:
      "Resurrects a crea that died in the last 200 years to life with new body and full HP; see B (25k gp cons.)",
    descriptionFull:
  ...
  "wall of fire": {
    ...
    save: "Dex",
    description:
      "60\xD71\xD720ft (l\xD7w\xD7h) or 10-ft rad all in and 10 ft on 1 side 5d8+1d8/SL Fire dmg; save halves; see B",
    descriptionMetric:
      "18\xD70,3\xD76m (l\xD7w\xD7h) or 3-m rad all in and 3 m on 1 side 5d8+1d8/SL Fire dmg; save halves; see B",
    descriptionShorter:
      "60|1|20ft (l|w|h) or 10-ft rad all + 10 ft on 1 side 5d8+1d8/SL Fire dmg; save half; see B",
    descriptionShorterMetric:
      "18|0,3|6m (l|w|h) or 3-m rad all + 3 m on 1 side 5d8+1d8/SL Fire dmg; save half; see B",
    descriptionFull:
  ...
  "wall of force": {
    ...
    duration: "Conc, 10 min",
    description:
      "10 10\xD710-ft panels or 10-ft rad (hemi)sphere invisible, impenetrable wall; can float in air; see book",
    descriptionFull:
  ...
  "wall of ice": {
    ...
    save: "Dex",
    description:
      "10 10\xD710-ft panels 1-ft thick wall; at casting 10d6 Cold dmg; save halves; can cut through; see book",
    descriptionFull:
  ...
  "wall of stone": {
    ...
    duration: "Conc, 10 min",
    description:
      '10 10\xD710-ft panels 6" thick wall connected with existing stone; half thickness, double surface; see B',
    descriptionMetric:
      "10 10\xD73m panels 15cm thick wall connected with existing stone; half thickness, double surface; see B",
    descriptionFull:
  ...
  "wall of thorns": {
    ...
    save: "Dex",
    description:
      "60\xD75\xD720ft (l\xD7w\xD7h) or 10-ft rad all 7d8+1d8/SL Piercing dmg; save halves; 1/4 move; see book",
    descriptionMetric:
      "18\xD71,5\xD76m (l\xD7w\xD7h) or 3-m rad all 7d8+1d8/SL Piercing dmg; save halves; 1/4 move; see book",
    descriptionFull:
  ...
  weird: {
    ...
    save: "Wis",
    description:
      "30-ft rad all crea save or frightened; extra save at end of each turn to stop, on fail 4d10 Psychic dmg", // errata from start of turn to end of turn
    descriptionShorter:
      "30-ft rad all crea save or frightened; save at end of turn to stop, on fail 4d10 Psychic dmg",
    descriptionFull:
  ...
  "wind wall": {
    ...
    save: "Str",
    description:
      "50\xD71\xD715ft (l\xD7w\xD7h) wall, any line-shape, at cast all in 3d8 Bludg. dmg; save halves; blocks arrows",
    descriptionMetric:
      "15\xD70,3\xD74,5m (l\xD7w\xD7h) wall, any line-shape, at cast all in 3d8 Bludg. dmg; save halves; blocks arrows",
    descriptionShorterMetric:
...
export const AllSpellsArray = [];
export const AllSpellsObject = {};
export let AddSpellsMenu;
export let AllCasterClasses;
export let spDias;
